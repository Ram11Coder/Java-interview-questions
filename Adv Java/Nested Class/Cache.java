...
//See the byte code for more details
...
public class Cache {
	...
	public CacheIterator iterator() {
		// MyCacheIterator.this.go();//need to check
		return new MyCacheIterator(); // Cache$CacheIterator(this),this -> Cache Object
	}
	...
	public static void main(String[] args) {
		...
		Cache.MyCacheIterator caches = recommendedItems.new MyCacheIterator();
		caches.go();
