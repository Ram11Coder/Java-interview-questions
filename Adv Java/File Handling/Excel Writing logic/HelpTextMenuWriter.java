...
public class HelpTextMenuWriter {
	...
	public static void main(String[] args) throws Exception {
		BufferedWriter bw = new BufferedWriter(
				new FileWriter("D:/Downloads/LanguageTranslator/exception/HTM/invalidFiles.txt"));
		HelpTextMenuWriter jsonWriter = new HelpTextMenuWriter();
		File folder = new File("D:/Downloads/LanguageTranslator/LanguageTranslator/Sources/HelpTextMenu");
	...
	public void writeToFile(String splitArray1) throws IOException {
		BufferedWriter outputWriter = new BufferedWriter(new OutputStreamWriter(
				new FileOutputStream(
						"D:/Downloads/LanguageTranslator/Destination/UnicodeJsonComponents/HelpTextMenu/" + filename),
				"UTF-8"));
	...
	public void dataGeneratorr(String filename) throws IOException {
		...
		try {
			String path = "D:/Downloads/LanguageTranslator/LanguageTranslator/TranslatedFiles/HelpTextMenu/HelpTextMenu/"
					+ filename + ".xlsx";
