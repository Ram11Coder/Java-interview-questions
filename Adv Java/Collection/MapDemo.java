...
public class MapDemo {
	...
	private static void immutableKeysDemo() {
		...
		list.add(2);
		/**
		 * return null - Arraylist have update so hashcode is different Arraylist have
		 * override own hashcode() method
		 */
		...
		s.setName("John");
		/**
		 * This returns correct value 1 because after updating the name of student would
		 * not impact hashcode method because it doesn't override hashcode method in
		 * object class
		 */
